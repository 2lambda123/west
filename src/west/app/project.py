...
''')
    ...
    def die_already(self, where, also=None):
        """Kills the program if already initialized.
        Parameters:
            - where (str): The location where the program is already initialized.
            - also (str): Additional information to include in the error message, if applicable.
        Returns:
            - None: This function does not return anything.
        Processing Logic:
            - Kills the program if already initialized.
            - Includes the location and any additional information in the error message."""
...
''')
    ...
    def do_run(self, args, user_args):
        """Purpose:
            This function runs the specified project, skipping inactive projects unless the user specifies otherwise.
        Parameters:
            - self: The current object.
            - args: The arguments passed to the function.
            - user_args: The arguments passed by the user.
        Returns:
            - None: The function does not return anything.
        Processing Logic:
            - Ensures that the project has a git repository.
            - Skips inactive projects unless the user specifies otherwise.
            - Delays computing derived values, such as SHAs, unless they are specifically requested.
...
class ManifestCommand(_ProjectCommand):
    ...
    def _die_if_manifest_project_filter(self, action):
        """Function: _die_if_manifest_project_filter
        Parameters:
            - action (str): The action being performed by the user.
        Returns:
            - None: This function does not return anything.
        Processing Logic:
            - Checks if the manifest.project-filter option is set.
            - If set, raises an error message.
            - Suggests clearing the project-filter configuration option and re-running the command.
            - If there is a use case for resolving the manifest while projects are made inactive by the project filter, suggests contacting the west developers.
        Example:
            _die_if_manifest_project_filter('update')
            # Error message: "west manifest --update" is not (yet) supported when the manifest.project-filter option is set. Please clear the project-filter configuration option and re-run this command, or contact the west developers if you have a use case for resolving the manifest while projects are made inactive by the project filter."""
